...
const BusinessCard = ({ business }: { business: Business }) => {
  ...
  return (
    <Card className="bg-white/5 border-white/15 backdrop-blur-[10px] hover:border-primary hover:backdrop-blur-[12px] transition-all duration-300">
      <CardHeader>
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 space-y-4 overflow-y-auto pr-2 -mr-2">
        ...
        {!isLoading && hasSearched && businesses.length === 0 && (
            <Card className="text-center p-8 bg-card/50 backdrop-blur-lg border-border">
